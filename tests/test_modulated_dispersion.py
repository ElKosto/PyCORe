...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 19 15:56:15 2021
...
PhysicalParameters = {'n0' : 1.9,
                      ...
                      'Dint' : Dint,
                      'Modulated D2': 2*np.pi*D2/3}

simulation_parameters = {'slow_time' : 1e-6,
                         'detuning_array' : dOm,
                         'electro-optical coupling' : -40*(25e6*2*np.pi),
                         'noise_level' : 1e-8,
                         'output' : 'map',
...
map2d = single_ring.Propagate_SplitStepCLIB(simulation_parameters, Pump,dt=1/single_ring.FSR/128*single_ring.kappa/2)
