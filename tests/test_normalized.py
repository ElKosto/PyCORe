...
simulation_parameters = {'slow_time' : 0.11*nn, #numper of photonliferimes per whole simlulation region
                         'detuning_array' : dOm,
...
map2d = single_ring.Propagate_SplitStep(simulation_parameters, Pump,dt=0.5e-4,Normalized_Units=True)
#%%
plt.figure()
